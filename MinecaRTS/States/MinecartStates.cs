...
namespace MinecaRTS
{
    class MoveToDepositBox : State<Minecart>
    {
        ...
        public override void Execute(Minecart owner)
        {
            ...
            if (owner.CollisionRect.GetInflated(24, 24).Intersects(owner.TargetDepositBox.CollisionRect))
            {
    ...
    public class ReturnToTownHall : State<Minecart>
    {
        ...
        public override void Execute(Minecart owner)
        {
            if (owner.CollisionRect.GetInflated(24, 24).Intersects(owner.TargetTownHall.CollisionRect))
            {
